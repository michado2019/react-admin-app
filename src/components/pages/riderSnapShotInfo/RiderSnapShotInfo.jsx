  ...
  return (
    <div className='riderSnapShotInfoWrapper'>
      <div className='riderSnapShotInfo-div'>
        ...
        <img src='https://img.icons8.com/external-others-inmotus-design/2x/external-Avatar-man-hair-avatars-others-inmotus-design-10.png' alt='img' className='riderSnapShotInfo-img' />
        </div>
